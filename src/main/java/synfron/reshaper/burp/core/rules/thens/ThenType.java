...
public class ThenType<T extends Then<T>> extends RuleOperationType<T> {
    ...
    public static final ThenType<ThenEvaluate> Evaluate = new ThenType<>("Evaluate", ThenEvaluate.class);
    ...
    public static final ThenType<ThenSendMessage> SendMessage = new ThenType<>("Send Message", ThenSendMessage.class);
